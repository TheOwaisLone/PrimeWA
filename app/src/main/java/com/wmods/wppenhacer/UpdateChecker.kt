...
class UpdateChecker(private val mActivity: Activity) : Runnable {
    ...
    companion object {
        private const val LATEST_RELEASE_API = "https://api.github.com/repos/TheOwaisLone/PrimeWA/releases/latest"
        private const val TELEGRAM_UPDATE_URL = "https://t.me/primewa"
